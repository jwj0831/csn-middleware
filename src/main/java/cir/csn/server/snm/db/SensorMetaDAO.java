...
public class SensorMetaDAO {
	...
	public void addSensorMeta(String uri, String ip, String id) throws ClassNotFoundException, SQLException {
	...
	public void deleteAllSensorMeta() throws ClassNotFoundException, SQLException {
		Connection c = connectionMaker.makeConnection();
		PreparedStatement ps = c.prepareStatement("DELETE FROM csn_snsr_meta");
		ps.executeUpdate();
